...
$dataAllDeprec = $DeprecList->DeprceListDel($db);
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"><i class="mdi mdi-trash-can"></i> ถังขยะค่าเสื่อมราคา </h4>
                        ...
                        <table id="deprecmanage" class="table table-bordered dt-responsive nowrap table-striped align-middle table-hover" style="width:100%">
                            <thead>
                                <tr class="text-center">
                                    <th hidden>รหัสค่าเสื่อมราคา</th>
                            ...
                            <tbody>
                                <?php foreach ($dataAllDeprec as $key_deprec => $value_deprec) { ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <h5><span class="badge rounded-pill bg-<?php echo $value_deprec['AMS_DEPRECIATION_ST'] == '99' ? 'danger' : 'info'; ?> text-dark"><i class="mdi mdi-tag"></i> <?php echo $value_deprec['AMS_DEPRECIATION_ST'] == '99' ? 'ถังขยะ' : ''; ?></h5></span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm btn-warning2 remove-item-btn text-black" data-bs-toggle="modal" data-bs-target="#RestoreBDRecordModal" data-bs-idbd="<?php echo $value_deprec['AMS_DEPRECIATION_ID']; ?>"><b><i class="mdi mdi-restore"></i> นำข้อมูลกลับไปใช้</b></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="?Page=deprec-result" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="Actiondeprec" name="Actiondeprec" value="Restore">
