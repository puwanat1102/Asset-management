        ...
        <form class="form-horizontal" id="f_productset" name="f_productset" action="?Page=pdc-result" method="post" autocomplete="off">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1"><i class="mdi mdi-plus-box"></i> <?php echo $editId == "" ? 'เพิ่ม' : 'แก้ไข'; ?>ข้อมูลชุดครุภัณฑ์ <?php echo $editId; ?></h4>
                        ...
                        <div id="warningval" style="display: none;">
                            <div class="alert alert-danger alert-border-left alert-dismissible fade shadow show mb-xl-0" role="alert">
                                <i class="ri-error-warning-line me-3 align-middle fs-16"></i><strong>กรอกข้อมูลไม่ครบถ้วน</strong>
                                - กรุณากรอกข้อมูลให้ครบก่อนกดเพิ่มรายการครุภัณฑ์
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" name="txtproductsetname" id="txtproductsetname" required="required" maxlength="200">
                                ...
                                <div class="col-xxl-2 col-md-6">
                                    <div>
                                        ...
                                        <input type="number" class="required form-control" id="txtsetunit" name="txtsetunit" required="required" maxlength="10">
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" required="required" name="txtsetprice" id="txtsetprice" data-type="currency">
                                ...
                                <div class="col-xxl-4 col-md-6" style="display: none;">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" name="txtsetpriceall" id="txtsetpriceall" data-type="currency2" readonly>
                                ...
                                <div class="col-xxl-2 col-md-6">
                                    <div>
                                        ...
                                        <select class="required form-select" id="txtstatusproductset" name="txtstatusproductset" style="width: 100%; height:36px;" required>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select js-example-basic-single" id="txtrubpid" name="txtrubpid" style="width: 100%; height:36px;">
                                            ...
                                            <?php foreach ($result_listAllUser as $key_user => $value_user) { ?>
                                                <option value="<?php echo $value_user['AMS_USER_ID']; ?>"><?php echo $value_user['AMS_USER_PNAME'] . $value_user['AMS_USER_FNAME'] . ' ' . $value_user['AMS_USER_LNAME']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-md-6 text-center">
                                    <h4 class="text-danger">*ใส่จำนวนรายการครุภัณฑ์แล้วกดปุ่มเพิ่มรายการครุภัณฑ์</h4>
                                </div>
                                <div class="col-xxl-4 col-md-6 text-right">
                                    <div id="addsetall" style="display: block;">
                                        <hr />
                                        <button type="button" class="btn btn-success text-dark" id="rowall-button">เพิ่มรายการครุภัณฑ์</button>
                                        <!-- <button type="button" class="btn btn-warning2 text-dark" id="removeall-button">ลบรายการทั้งหมด</button> -->
                                        <!-- <button type="button" class="btn btn-info text-dark" id="row-button">เพิ่มทีละรายการ</button>
                                        <button type="button" class="btn btn-danger2 text-dark" id="remove-button">ลบทีละรายการ</button> -->
                                    </div>
                                    <div id="editset" style="display: none;">
                                        <hr />
                                        <button type="button" class="btn btn-warning2 text-dark" id="rowedit-button">แก้ไขข้อมูล</button>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1"><i class="mdi mdi-plus-box"></i> <?php echo $editId == "" ? 'เพิ่ม' : 'แก้ไข'; ?>รายการครุภัณฑ์ <?php echo $editId; ?></h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="border-top">
                                <div class="card-body text-right">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="mdi mdi-content-save"></i> บันทึกข้อมูล</button>
                                </div>
                            </div> -->
                            <!-- </form> -->
                        </div>
