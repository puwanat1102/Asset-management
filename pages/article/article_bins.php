...
$ArticleBins = new ArticleResult();
$ListArticleAllBins = $ArticleBins->ListArticleAllBins($db);
?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"><i class="mdi mdi-trash-can"></i> ถังขยะวัสดุ </h4>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="articlebins" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            <thead>
                            ...
                            <tbody>
                                <?php foreach ($ListArticleAllBins as $key_atc => $value_atc) {
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?php echo $ArticleBins->dateToThai($value_atc["AMS_ARTICLE_EXPDATE"]); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <h5><span class="badge rounded-pill bg-<?php echo $value_atc['AMS_ARTICLE_ST'] == '99' ? 'danger' : 'info'; ?> text-dark"><i class="mdi mdi-tag"></i> <?php echo $value_atc['AMS_ARTICLE_ST'] == '99' ? 'ถังขยะ' : ''; ?></h5></span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm btn-warning2 remove-item-btn text-black" data-bs-toggle="modal" data-bs-target="#RestoreBDRecordModal" data-bs-idbd="<?php echo $value_atc['AMS_ARTICLE_ID']; ?>"><b><i class="mdi mdi-restore"></i> นำข้อมูลกลับไปใช้</b></button>
                                        </td>
                                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="?Page=atc-result" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="Actionarticle" name="Actionarticle" value="Restore">
