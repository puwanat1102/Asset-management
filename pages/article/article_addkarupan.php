        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="f_articleed" name="f_articleed" action="?Page=atc-resultkrp" method="post" autocomplete="off">
                            <div class="row gy-4">
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        <label for="txtnameatc" class="form-label"><b>ชื่อวัสดุ</b></label>
                                        <input type="text" class="required form-control" id="txtnameatc" name="txtnameatc" value="<?php echo $EditResultact['0']['AMS_ARTICLE_NM']; ?>" disabled="disabled">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <select class="required form-select" id="txttypeatc" name="txttypeatc" style="width: 100%; height:36px;" disabled="disabled">
                                            <option value="10" <?php if ($EditResultact['0']['AMS_ARTICLE_TYPE'] == '10') {
                                                                    echo 'selected';
                                                                } ?>>วัสดุสิ้นเปลือง</option>
                                            <option value="20" <?php if ($EditResultact['0']['AMS_ARTICLE_TYPE'] == '20') {
                                                                    echo 'selected';
                                                                } ?>>วัสดุคงทน</option>
                                        </select>
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="number" class="required form-control" id="txtcnt" name="txtcnt" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;" value="<?php echo $EditResultact['0']['AMS_ARTICLE_QTY']; ?>" disabled="disabled" />
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" name="txtunit" value="<?php echo $EditResultact['0']['AMS_ARTICLE_UNIT']; ?>" disabled="disabled">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" name="txtprice" id="txtprice" data-type="currency" value="<?php echo $EditResultact['0']['AMS_ARTICLE_PRICE']; ?>" disabled="disabled" >
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="required form-control" id="txtexpdate" name="txtexpdate" value="<?php echo $ArticleEdit->dateToThai($EditResultact['0']['AMS_ARTICLE_EXPDATE']); ?>" disabled="disabled">
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-xxl-4 col-md-6">
                                    <div>
                                        ...
                                        <select class="required form-select js-example-basic-single" id="txtlctatc" name="txtlctatc" style="width: 100%; height:36px;" disabled="disabled" >
                                            <?php foreach ($lctList as $key_lct => $value_lct) { ?>
                                                <option value="<?php echo $value_lct["AMS_LCT_ID"]; ?>" <?php if ($EditResultact['0']['AMS_ARTICLE_LCT'] == $value_lct["AMS_LCT_ID"]) {
                                                                                                            echo 'selected';
                                ...
                                <div class="col-xxl-4 col-md-6">
                                    <div>
                                        ...
                                        <select class="required form-select" id="txtatcst" name="txtatcst" style="width: 100%; height:36px;" disabled="disabled" >
                                            <option name="txtatcst" value="10" <?php if ($EditResultact['0']['AMS_ARTICLE_ST'] == '10') {
                                                                                    echo 'selected';
                                                                                } ?>>ใช้งาน</option>
                                            <option name="txtatcst" value="20" <?php if ($EditResultact['0']['AMS_ARTICLE_ST'] == '20') {
                                                                                    echo 'selected';
                                                                                } ?>>แบบร่าง</option>
                                        </select>
