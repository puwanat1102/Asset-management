...
//Products
//Successproduct Message
if (document.getElementById("sa-successpdc"))
    document.getElementById("sa-successpdc").addEventListener("click", function () {
        Swal.fire({
            ...
            window.location = "?Page=product-manage";
        });
    });

    if (document.getElementById("sa-errorpdc"))
    document.getElementById("sa-errorpdc").addEventListener("click", function () {
        Swal.fire({
...
if (document.getElementById("sa-successatc"))
    document.getElementById("sa-successatc").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=atc-manage";
        });
    });

    if (document.getElementById("sa-erroratc"))
    document.getElementById("sa-erroratc").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
...
// Budget
if (document.getElementById("sa-successbd"))
    document.getElementById("sa-successbd").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=budget-manage";
        });
    });

    if (document.getElementById("sa-errorbd"))
    document.getElementById("sa-errorbd").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
...
//Deprec
if (document.getElementById("sa-successdep"))
    document.getElementById("sa-successdep").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=deprec-setting";
        });
    });

    if (document.getElementById("sa-errordep"))
    document.getElementById("sa-errordep").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
...
//Repair
if (document.getElementById("sa-successrp"))
    document.getElementById("sa-successrp").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=rp-manage";
        });
    });

    if (document.getElementById("sa-errorrp"))
    document.getElementById("sa-errorrp").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
...
// User
if (document.getElementById("sa-successuser"))
    document.getElementById("sa-successuser").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=user-manage";
        });
    });

    if (document.getElementById("sa-erroruser"))
    document.getElementById("sa-erroruser").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
    ...
    if (document.getElementById("sa-successuserinfo"))
    document.getElementById("sa-successuserinfo").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=user-info";
        });
    });

    if (document.getElementById("sa-erroruserinfo"))
    document.getElementById("sa-erroruserinfo").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
    ...
    if (document.getElementById("sa-successuserpass"))
    document.getElementById("sa-successuserpass").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
    ...
    if (document.getElementById("sa-erroruserpass"))
    document.getElementById("sa-erroruserpass").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
            ...
            window.location = "?Page=user-pass";
        });
    });

    if (document.getElementById("sa-successuserlct"))
    document.getElementById("sa-successuserlct").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลสำเร็จ',
            // text: 'You clicked the button!',
            icon: 'success',
            ...
            window.location = "?Page=user-lcts";
        });
    });

    if (document.getElementById("sa-erroruserlct"))
    document.getElementById("sa-erroruserlct").addEventListener("click", function () {
        Swal.fire({
            title: 'บันทึกข้อมูลไม่สำเร็จ',
            // text: 'You clicked the button!',
            icon: 'error',
